...
export default function LatestGallery() {
  ...
  const displayImages = [
    ...
    images[2] ||
      "https://images.unsplash.com/photo-1478147424044-f252df6e8557?q=80&w=800&auto=format&fit=crop",
    images[3] ||
      ...
      <div className="flex flex-col gap-4">
        <div className="bg-slate-200 rounded-3xl h-64 w-full shadow-sm overflow-hidden relative">
          ...
          <div className="absolute inset-0 bg-brand-primary/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
            <span className="text-white font-bold text-xs uppercase tracking-widest border border-white px-4 py-2 rounded-full backdrop-blur-sm">
              Open Album
            </span>
          </div>
        </div>
