...
export default function LoadingState({
    ...
    if (variant === "full") {
        return (
            <div
                className="fixed inset-0 z-[200] flex flex-col items-center justify-center bg-brand-surface/80 backdrop-blur-md animate-in fade-in duration-500">
    ...
    if (variant === "overlay") {
        return (
            <div
                className="absolute inset-0 z-10 flex flex-col items-center justify-center bg-white/50 backdrop-blur-[2px] rounded-3xl animate-in fade-in">
