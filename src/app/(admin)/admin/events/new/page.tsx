            ...
            <div
                ...
                <div className="max-w-4xl w-full">
                    <Link href="/admin/events"
                          className="text-sm font-bold text-brand-secondary mb-8 block hover:underline">← Back to Events
                        Dashboard</Link>
                    <div className="flex flex-col items-center">
                        <h1 className="text-3xl md:text-4xl font-serif font-bold text-brand-primary text-center mb-4">What
                            kind of event are you creating?</h1>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-10">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="bg-slate-50 p-4 rounded-2xl border border-gray-100">
                                <label
                                    className="text-[10px] font-bold text-brand-primary uppercase tracking-widest mb-3 flex items-center gap-1"><MapPin
                                    size={12}/> Event Location</label>
                            ...
                            <div className="flex flex-col sm:flex-row gap-6 items-start">
                                <div
                                    ...
                                    {flyerUrl ?
                                        ...
                                        <div className="text-gray-900 flex flex-col items-center"><ImageIcon size={32}
                                                                                                             className="mb-2"/><span
                        ...
                        <div className="space-y-6 p-6 md:p-8 bg-slate-50 border border-gray-100 rounded-3xl">
                                    ...
                                    {recurringPattern === 'weekly' && recurringDay === 'sunday' && title.toLowerCase().includes('sunday') ? (
                                        <div
                                            ...
                                            <div
                                                ...
                                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                    <div><label className="text-xs font-bold text-gray-900 block mb-1">2nd
                                                        Sunday</label><input value={sundayFactions.second_sunday}
                                                    ...
                                                    <div><label className="text-xs font-bold text-gray-900 block mb-1">3rd
                                                        Sunday</label><input value={sundayFactions.third_sunday}
                                                                             onChange={e => setSundayFactions({
                                                                                 ...sundayFactions,
                                                    ...
                                                    <div><label className="text-xs font-bold text-gray-000 block mb-1">4th
                                                        Sunday</label><input value={sundayFactions.fourth_sunday}
                                                                             onChange={e => setSundayFactions({
                                                                                 ...sundayFactions,
                                                    ...
                                                    <div><label className="text-xs font-bold text-gray-900 block mb-1">5th
                                                        Sunday</label><input value={sundayFactions.fifth_sunday}
                                                                             onChange={e => setSundayFactions({
                                                                                 ...sundayFactions,
                                            ...
                                            <div
                                                ...
                                                <div className="flex flex-col sm:flex-row gap-4">
                                                    ...
                                                    <div className="w-full sm:w-32"><label
                                                        ...
                                                        type="time" value={thanksgivingSession.start_time}
                                                        onChange={e => setThanksgivingSession({
                                                            ...thanksgivingSession,
                                                    ...
                                                    <div className="w-full sm:w-32"><label
                                                        ...
                                                        type="time" value={thanksgivingSession.end_time}
                                                        onChange={e => setThanksgivingSession({
                                                            ...thanksgivingSession,
                                                    ...
                                                    {standardSessions.map((session, index) => (
                                                        <div key={index} className="flex flex-col sm:flex-row gap-4">
                                                            <div className="flex-1"><label
                                                                ...
                                                                Name</label><input value={session.name} onChange={e => {
                                                            ...
                                                            <div className="w-full sm:w-32"><label
                                                                ...
                                                                Time</label><input type="time" value={session.end_time}
                                                                                   onChange={e => {
                                                                                       const s = [...standardSessions];
                                        ...
                                        <div
                                            ...
                                            <div><label
                                                ...
                                                Time</label><input type="time" value={startTime}
                                                                   onChange={e => setStartTime(e.target.value)}
                                                                   className="w-full p-4 border rounded-xl bg-white focus:ring-2 focus:ring-brand-primary outline-none"/>
                                            </div>
                                            <div><label
                                                className="text-[10px] font-bold text-gray-900 uppercase block mb-2">End
                                                Time</label><input type="time" value={endTime}
                            ...
                            {eventType === 'single_day' && (
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 animate-in fade-in">
                                    <div><label className="text-[10px] font-bold text-gray-900 uppercase block mb-2">Specific
                                        Date</label><input type="date" required value={singleDate}
                                                           onChange={e => setSingleDate(e.target.value)}
                                                           className="w-full p-4 border rounded-xl bg-white focus:ring-2 focus:ring-brand-primary outline-none"/>
                                    </div>
                                    <div><label className="text-[10px] font-bold text-gray-900 uppercase block mb-2">Start
                                        Time</label><input type="time" required value={startTime}
                                                           onChange={e => setStartTime(e.target.value)}
                                                           className="w-full p-4 border rounded-xl bg-white focus:ring-2 focus:ring-brand-primary outline-none"/>
                                    </div>
                                    <div><label className="text-[10px] font-bold text-gray-900 uppercase block mb-2">End
                                        Time</label><input type="time" required value={endTime}
                                                           onChange={e => setEndTime(e.target.value)}
                                                           className="w-full p-4 border rounded-xl bg-white focus:ring-2 focus:ring-brand-primary outline-none"/>
                                    </div>
                                </div>
                                    ...
                                    {multiDays.map((day, index) => (
                                        <div key={index}
                                            ...
                                            <div className="flex flex-col sm:flex-row gap-4 items-end w-full">
                                                <div className="flex-[0.5] w-full"><label
                                                    className="text-[10px] font-bold text-gray-900 uppercase block mb-1">Label</label><input
                                                    value={day.label} onChange={e => {
                                                ...
                                                <div className="flex-1 w-full"><label
                                                    className="text-[10px] font-bold text-gray-900 uppercase block mb-1">Date</label><input
                                                    type="date" required value={day.date} onChange={e => {
                                                    const newDays = [...multiDays];
                                                ...
                                                <div className="flex-1 w-full"><label
                                                    className="text-[10px] font-bold text-gray-900 uppercase block mb-1">Start</label><input
                                                    type="time" required value={day.start_time} onChange={e => {
                                                    const newDays = [...multiDays];
                                                ...
                                                <div className="flex-1 w-full"><label
                                                    className="text-[10px] font-bold text-gray-900 uppercase block mb-1">End</label><input
                                                    type="time" required value={day.end_time} onChange={e => {
                                                    const newDays = [...multiDays];
                                            ...
                                            <div className="w-full flex gap-4">
                                                <div className="flex-1"><label
                                                    ...
                                                    for {day.label} (Optional)</label><input
                                                    placeholder="e.g. Pastor John Doe" value={day.guest_speaker || ""}
                                                    onChange={e => {
                                                        const newDays = [...multiDays];
                                                        newDays[index].guest_speaker = e.target.value;
                                                        setMultiDays(newDays);
                                                    }}
                        ...
                        {eventType !== 'recurring' && (
                            <div className="space-y-6 animate-in fade-in">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                    {eventType === 'single_day' && (
                                        <div><label
                                            className="text-[10px] font-bold text-gray-400 uppercase block mb-2">Guest
                                            Speaker(s)</label><input value={globalGuestSpeaker}
                                    ...
                                    <div className={eventType === 'multi_day' ? 'md:col-span-2' : ''}><label
                                        className="text-[10px] font-bold text-gray-400 uppercase block mb-2">Global
                                        Theme</label><input value={theme} onChange={e => setTheme(e.target.value)}
                                                            placeholder="e.g. Let There Be Light"
                                                            className="w-full p-4 border rounded-xl focus:ring-2 focus:ring-brand-primary outline-none"/>
                                    </div>
                                    <div className={eventType === 'multi_day' ? 'md:col-span-1' : ''}><label
