    ...
    if (isInitialLoad) {
        return (
            <div className="min-h-screen bg-brand-surface p-6 md:p-12">
                <AdminSkeletonLoader variant="sermon-library"/>
            </div>
        );
    }
                                ...
                                <tr key={s.id}
                                    ...
                                    <td className="p-5">
                                        ...
                                        <div className="flex items-center gap-2 mt-2">
                                            ...
                                            {s.link_twitter && (
                                                <a href={s.link_twitter} target="_blank" rel="noreferrer"
                                                   title="View on X"
                                            ...
                                            {(s.link_spotify || s.link_apple || s.link_ytmusic) && (
                                                <div
                                                    ...
                                                    {s.link_apple &&
                                                        <a href={s.link_apple} target="_blank" rel="noreferrer"
                                            ...
                                            {s.banner_url && (
                                                <a href={s.banner_url} target="_blank" title="View Banner"
                                                   className="text-emerald-600 hover:scale-110 transition-transform">
                                                    ...
                                                    <span
                                                        className="text-[10px] font-black underline italic">Banner</span>
                                                </a>
                                            )}
                                            {s.clip_url && (
                                    ...
                                    <div className="flex gap-4">
                                        {s.youtube_url &&
                                            <a href={s.youtube_url} target="_blank" className="text-red-600"><MediaIcon
                                                type="youtube"/></a>}
                                        {s.banner_url &&
                                            <a href={s.banner_url} target="_blank"
                                               className="text-emerald-600"><MediaIcon
                                                type="banner"/></a>}
                                        {s.clip_url &&
