        ...
        <div className="min-h-screen bg-brand-surface p-6 md:p-12">
            ...
            <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="church-card group cursor-pointer hover:border-brand-secondary transition-all">
                    ...
                    <button className="w-full btn-primary text-sm py-2">Open Manager</button>
                </div>
                ...
                <div className="church-card group cursor-pointer hover:border-brand-secondary transition-all">
                    ...
                    <button className="w-full bg-gray-100 text-brand-primary font-bold px-6 py-2 rounded-lg text-sm hover:bg-gray-200">Manage Photos</button>
                </div>
