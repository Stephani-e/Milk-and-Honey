                    ...
                    <form className="space-y-10" onSubmit={(e) => e.preventDefault()}>
                        ...
                        <div className="pt-10 border-t border-gray-100 space-y-6">
                            ...
                            <div className="bg-brand-surface p-6 rounded-2xl border border-brand-accent max-w-md">
                                ...
                                {isUploading ? (
                                    // 1. THE UPLOADING STATE (Beautiful animated spinner)
                                    <div
                                    ...
                                    // 2. THE PREVIEW STATE (Your existing code)
                                    <div
                                    ...
                                    <UploadButton
                                        ...
                                        onUploadError={(error) => {
                                            setIsUploading(false); // Turn off the spinner on error
