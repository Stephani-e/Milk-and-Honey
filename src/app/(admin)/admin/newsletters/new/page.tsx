                ...
                <div className="bg-white rounded-3xl p-8 shadow-sm border border-brand-accent">
                    ...
                    <form className="space-y-10">
                        ...
                        <div className="pt-10 border-t border-gray-100 space-y-6">
                            <label className="text-xs font-bold uppercase tracking-widest text-purple-400 mb-2">
                                Step 2: Cover Image
                            </label>
                            ...
                            <div className="bg-brand-surface p-6 rounded-2xl border border-brand-accent max-w-md">
                                {isUploading ? (
                                    ...
                                    <div
                                        className="flex flex-col items-center justify-center p-8 bg-white border border-brand-accent border-dashed rounded-2xl gap-4 shadow-sm"
                                    >
                                        <svg
                                    ...
                                    <UploadButton
                                        ...
                                        onUploadBegin={() => {
                                            setIsUploading(true); // Triggers the spinner
                                        }}
                                        onClientUploadComplete={(res) => {
                                            setFormData({...formData, cover_image_url: res[0].ufsUrl});
                                            setImageUploaded(true);
                                            setIsUploading(false); // Turns off the spinner
                                            toast.success("Cover image uploaded successfully");
                                        }}
                                        onUploadError={(error) => {
                                            setIsUploading(false); // Turns off the spinner on error
