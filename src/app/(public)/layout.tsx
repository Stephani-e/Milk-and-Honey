...
import {ArrowRight, Camera, ChevronDown, Menu, X} from "lucide-react";
                    ...
                    <div className="hidden md:flex items-center gap-6 z-50">
                        ...
                        <div className="flex items-center gap-4 text-gray-400">
                            <a href={CHURCH_INFO.socialMedia.instagram} target="_blank" rel="noreferrer"
                               className="hover:text-pink-600 transition-colors" aria-label="Instagram">
                            ...
                            <a href={CHURCH_INFO.socialMedia.twitter} target="_blank" rel="noreferrer"
                               className="hover:text-green-600 transition-colors" aria-label="X(Twitter)">
                                <TwitterIcon size={18}/>
                            </a>
                        </div>
                        <Link href="/events"
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-sm text-gray-500 font-medium">
                            <li>
                                ...
                                >
                                    <svg className="w-4 h-4 mt-0.5 text-white group-hover:text-amber-600 flex-shrink-0"
                            ...
                            <li>
                                <a href={`mailto:${CHURCH_INFO.contact.email}`}
                                   className="flex items-center gap-2 hover:text-amber-600 transition-colors group">
                                    <svg className="w-4 h-4 text-white group-hover:text-amber-600 flex-shrink-0"
                                         fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                                        <path strokeLinecap="round" strokeLinejoin="round"
