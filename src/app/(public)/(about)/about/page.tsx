...
export default function AboutPage() {
    ...
    return (
        <div className="flex flex-col bg-white">
            ...
            <section className="py-20 md:py-32">
                <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="relative group">
                        ...
                        <div
                            className="absolute -bottom-6 -right-6 hidden md:block w-full h-full border-4 border-amber-100 rounded-[3.5rem] -z-10 group-hover:translate-x-2 group-hover:translate-y-2 transition-transform"></div>
                    </div>

                    <div className="space-y-8">
                        <div
                            className="inline-flex items-center gap-2 px-4 py-2 bg-amber-50 rounded-full text-amber-700 text-xs font-bold uppercase tracking-widest">
                        ...
                        <div className="space-y-6 text-gray-500 leading-relaxed text-lg">
                            <p>
                                Milk & Honey Center began with a simple but powerful mandate: to create a dwelling place
                                for God's presence where lives are transformed and leaders are birthed.
                            </p>
                            <p>
                                As a vibrant parish under the <strong>Redeemed Christian Church of God (RCCG) Lagos
                                Province 56</strong>, we have grown into a family of believers dedicated to the word of
                                God, fervent prayer, and genuine communal love.
                            </p>
                        </div>

                        <Link href='/history'
                              className="inline-flex items-center gap-2 px-6 py-3 bg-brand-primary text-white rounded-full hover:bg-amber-600 transition-colors"
                        >
                            <button>
                                Our History
                            </button>
            ...
            <section
                className="py-20 md:py-24 bg-brand-primary text-white relative overflow-hidden rounded-[3rem] md:rounded-[4rem] mx-2 md:mx-6 shadow-2xl">
                ...
                <div className="max-w-7xl mx-auto px-6 relative z-10">
                    <div className="text-center mb-16">
                        <span
                            className="text-amber-400 font-bold tracking-widest uppercase text-[10px] mb-2 block font-sans">The Mandate</span>
                        <h2 className="text-3xl md:text-5xl font-serif font-black mb-6">Our Global Vision</h2>
                        <p className="text-slate-300 max-w-2xl mx-auto text-base md:text-lg">As a parish of The Redeemed
                            Christian Church of God, we are wholly committed to this global, God-given mandate.</p>
                    </div>
                        ...
                        {[
                            {
                                ...
                                text: "Our primary goal is to make heaven. We believe holiness is the non-negotiable lifestyle for every believer."
                            },
                            {
                                id: "2",
                                title: "To Take As Many People With Us",
                                text: "We are not going alone. Our mission is to win souls and lead a massive generation to the kingdom."
                            },
                            {
                                id: "3",
                                title: "To have Member of RCCG in Every Family of All Nations",
                                text: "We are an international family of God."
                            },
                            {
                                id: "4",
                                title: "To Accomplish No. 1 above, Holiness Will Be Our Lifestyle",
                                text: "Holiness will be our daily walk. We serve a holy God, and we reflect His nature in our character."
                            },
                            {
                                id: "5",
                            ...
                            {
                                id: "6",
                                title: "We will pursue these objectives until every Nation in the world is reached for the Lord Jesus Christ",
                                text: ""
                            }
                        ].map((item, idx) => (
                            <div key={idx}
                                 className="bg-white/5 border border-white/10 p-6 md:p-8 rounded-3xl hover:bg-white/10 transition-colors flex gap-5 items-start">
                                {/* The Number Badge (Now on the left side) */}
                                <div
                                    className="w-12 h-12 bg-amber-400 text-amber-950 rounded-2xl flex items-center justify-center font-black text-xl shrink-0 shadow-inner">
                                    {item.id}
                                </div>
                                {/* The Text Content */}
                                <div>
            ...
            <section className="py-20 md:py-32 bg-white">
                <div className="max-w-7xl mx-auto px-6">
                    <h2 className="text-3xl md:text-4xl font-serif font-black text-brand-primary text-center mb-16">Explore
                        Life at Milk & Honey</h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <Link href="/sermons"
                            ...
                            <div className="relative z-10 mt-auto pt-10">
                                ...
                                <p className="text-sm text-slate-300 leading-relaxed mb-6">
                                    Experience the transformation. Catch up on <span
                                    className="text-amber-400 font-bold">Sermons</span> and see God's glory in our
                                    recent moments.
                                </p>
                                <span
                                    className="text-xs font-black uppercase tracking-widest text-amber-400 group-hover:underline flex items-center gap-2">
                        ...
                        <Link href="/departments"
                            ...
                            <div className="relative z-10 flex justify-between items-start">
                                <div
                                    className="w-14 h-14 bg-white/20 backdrop-blur-md rounded-2xl flex items-center justify-center">
                                    <Camera className="text-white group-hover:scale-110 transition-transform"
                                            size={28}/>
                                </div>
                                <ArrowRight
                                    className="text-white/50 group-hover:text-amber-400 group-hover:translate-x-2 transition-all"
                            ...
                            <div className="relative z-10 mt-auto pt-10">
                                ...
                                <p className="text-sm text-slate-300 leading-relaxed mb-6">
                                    Our workforce is the engine of our church. Discover the <span
                                    className="text-amber-400 font-bold">Units</span> and find where you fit in.
                                </p>
                                <span
                                    className="text-xs font-black uppercase tracking-widest text-amber-400 group-hover:underline flex items-center gap-2">
                                    Join a Department
            ...
            <section className="relative w-full h-[500px] md:h-[650px] bg-slate-100 group">
                ...
                {/* Floating Map Card */}
                <div
                    className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 md:left-24 md:translate-x-0 w-[90%] md:w-[400px] bg-white rounded-3xl shadow-2xl p-8 md:p-10 border border-gray-100">
