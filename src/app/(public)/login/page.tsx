...
export default function LoginPage() {
    ...
    const handleLogin = async (e: React.FormEvent) => {
        ...
        if (error) alert("Access Denied: Please check your credentials.");
        else {
            router.push("/admin");
            router.refresh();
        }
                        ...
                        <form onSubmit={handleLogin} className="space-y-6">
                            <div className="text-left">
                                ...
                                <input
                                    ...
                                    className="w-full p-3 border border-[#E5E7EB] rounded-lg focus:outline-none focus:ring-2 focus:ring-[#11222E]"
