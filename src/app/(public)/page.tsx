      ...
      <section className="relative h-[85vh] min-h-[600px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl mx-auto mt-16 animate-in fade-in slide-in-from-bottom-4 duration-1000">
          ...
          <p className="text-base md:text-lg text-slate-200 mb-10 max-w-2xl mx-auto leading-relaxed">
            Join us this Sunday as we worship, learn, and grow together. There
            is a place for you here at Milk & Honey, Lagos Province 56.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-4 sm:mb-6">
            <Link
              href="/about"
              className="px-8 py-4 bg-amber-400 text-amber-950 font-bold rounded-full hover:bg-amber-300 transition-colors w-full sm:w-auto text-center"
            >
              I&apos;m New Here
            </Link>
            <Link
              href="/events"
              className="px-8 py-4 bg-white/10 text-white font-bold rounded-full border border-white/20 hover:bg-white/20 backdrop-blur-sm transition-colors w-full sm:w-auto flex items-center justify-center gap-2"
            >
          ...
          <div className="flex items-center justify-center">
            <Link
              href="/socials"
              className="text-white/80 text-sm font-bold hover:text-amber-400 transition-colors underline underline-offset-4"
            >
      ...
      <section className="py-20 md:py-28 bg-amber-50/30">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <span className="text-amber-600 font-bold tracking-widest uppercase text-[10px] mb-2 block">
              Who We Are
            </span>
            <h2 className="text-3xl md:text-4xl font-serif font-black text-brand-primary">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-10 rounded-[2rem] shadow-xl shadow-amber-900/5 border border-amber-100 hover:-translate-y-2 transition-transform duration-300">
              ...
              <p className="text-sm text-gray-500 leading-relaxed">
                We are a vibrant parish dedicated to raising leaders and
                transforming our community through the love of Christ.
              </p>
            </div>
            <div className="bg-white p-10 rounded-[2rem] shadow-xl shadow-amber-900/5 border border-amber-100 hover:-translate-y-2 transition-transform duration-300">
              <div className="w-14 h-14 bg-amber-100 rounded-full flex items-center justify-center text-amber-700 mb-6">
              ...
              <p className="text-sm text-gray-500 leading-relaxed">
                From the choir to the ushering unit, discover how your unique
                gifts can serve the church and the world.
              </p>
            </div>
            <div className="bg-white p-10 rounded-[2rem] shadow-xl shadow-amber-900/5 border border-amber-100 hover:-translate-y-2 transition-transform duration-300">
              <div className="w-14 h-14 bg-amber-100 rounded-full flex items-center justify-center text-amber-700 mb-6">
              ...
              <p className="text-sm text-gray-500 leading-relaxed">
                Your tithes, offerings, and donations empower our outreach
                programs and provincial missions.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 md:py-28 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
            ...
            <Link
              href="/life-stages"
              className="text-sm font-bold text-amber-600 hover:text-amber-700 flex items-center gap-2"
            >
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
            <div className="lg:w-1/3 text-center lg:text-left">
              ...
              <h2 className="text-3xl md:text-4xl font-serif font-black text-brand-primary mb-6">
                Experience Milk & Honey
              </h2>
              <p className="text-gray-500 text-sm leading-relaxed mb-8">
                Relive the powerful moments from our recent services,
                conferences, and community outreaches.
                <br />
                <br />
                <strong className="text-brand-primary">
                  Were you at a recent event?
                </strong>{" "}
                Share your own photos and videos to be featured in our community
                gallery!
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                <Link
                  href="/gallery"
                  className="px-8 py-3.5 bg-brand-primary text-white font-bold rounded-full hover:bg-slate-800 transition-colors shadow-lg"
                >
                  View Gallery
                </Link>
                <Link
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 flex flex-col md:flex-row items-center justify-between gap-12">
          <div className="max-w-xl text-center md:text-left">
            ...
            <p className="text-slate-300 text-sm md:text-base leading-relaxed mb-8">
              God has equipped you with unique talents. Whether it&apos;s
              playing an instrument, managing technical gear, or welcoming
              guests, there is a department waiting for you.
            </p>
            <Link
              href="/departments"
              className="inline-block px-8 py-4 bg-white text-brand-primary font-bold rounded-full hover:bg-amber-100 transition-colors"
            >
