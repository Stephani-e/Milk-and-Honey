            ...
            <main className="max-w-7xl mx-auto px-6 -mt-10 relative z-20 space-y-12">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-2 space-y-12">
                        {!featuredNewsletter ? (
                            <div
                                className="text-center py-20 bg-white rounded-3xl border border-gray-100 shadow-sm h-full flex flex-col items-center justify-center">
                                <Newspaper size={48} className="mx-auto text-gray-300 mb-4"/>
                                <h3 className="text-lg font-bold text-brand-primary">No updates published yet.</h3>
                                <p className="text-gray-500 mt-2">Check back soon for the latest news from the Milk &
                                    Honey family.</p>
                            </div>
                        ) : (
                            <>
                                {/* 1. THE FEATURED NEWSLETTER */}
                                <Link
                                ...
                                >
                                    <div
                                        className="aspect-video md:aspect-auto bg-slate-100 relative overflow-hidden h-full">
                                        {featuredNewsletter.cover_image_url ? (
                                            ...
                                            <div
                                                className="w-full h-full flex items-center justify-center bg-brand-surface text-brand-primary/20 min-h-[250px]">
                                                <Newspaper size={64}/>
                                            </div>
                                        )}
                                    ...
                                    <div className="p-8 flex flex-col justify-center">
                                        ...
                                        <p className="text-base text-gray-600 mb-8 leading-relaxed line-clamp-3">
                    ...
                    <div className="lg:col-span-1 space-y-8">
                        {/* Upcoming Highlights */}
                        <div
                            className="bg-white rounded-3xl p-6 md:p-8 shadow-xl shadow-brand-primary/5 border border-gray-100">
                            <div className="flex items-center justify-between mb-6 border-b border-gray-50 pb-4">
                                <h2 className="text-lg font-bold text-brand-primary flex items-center gap-2">
                                    <Calendar className="text-brand-secondary" size={18}/> Highlights
                                </h2>
                                <Link href="/events"
                            ...
                            {processedEvents.length === 0 ? (
                                <div
                                    className="p-6 text-center bg-slate-50 rounded-2xl border border-dashed border-gray-200">
                                    <p className="text-xs font-bold text-gray-400 italic">No major upcoming events
                                        listed at the moment.</p>
                                </div>
                            ) : (
                                    ...
                                    {processedEvents.map((event: any, idx: number) => (
                                        <div key={idx}
                                            ...
                                            <div
                                                ...
                                                <span
                                                    className="text-lg font-black text-brand-primary leading-none mt-1">
                ...
                <div
                    className="bg-white rounded-3xl p-8 md:p-12 shadow-xl shadow-brand-primary/5 border border-gray-100 flex flex-col md:flex-row items-center justify-between gap-8 mt-12">
