...
//                 );
//                 const res = await supabaseAdmin.from('newsletters').select('*').eq('slug', slug).maybeSingle();
//                 data = res.data;
//                 fetchError = res.error;
//             } else {
//                 const res = await supabase.from('newsletters').select('*').eq('slug', slug).eq('is_published', true).maybeSingle();
//                 data = res.data;
//                 fetchError = res.error;
//             }
//
...
//                 <SkeletonLoader variant="newsletter-slug"/>
//             </div>
//         );
//     }
//
...
//                         <div
//                             className="text-black leading-loose text-lg [&_img]:max-w-full [&_img]:h-auto [&_img]:rounded-xl [&>h1]:text-4xl [&>h1]:font-serif [&>h1]:mb-6 [&>h1]:mt-10 [&>h2]:text-3xl [&>h2]:font-serif [&>h2]:font-bold [&>h2]:mb-4 [&>h2]:mt-8 [&>h3]:text-2xl [&>h3]:font-bold [&>h3]:mb-3 [&>h3]:mt-6 [&>p]:mb-6 [&>ul]:list-disc [&>ul]:pl-6 [&>ul]:mb-6 [&>ul>li]:mb-2 [&>ol]:list-decimal [&>ol]:pl-6 [&>ol]:mb-6 [&>ol>li]:mb-2 [&>a]:underline [&>a]:font-bold [&>a]:break-all [&>blockquote]:border-l-4 [&>blockquote]:pl-4 [&>blockquote]:italic [&>blockquote]:bg-slate-50 [&>blockquote]:py-2 [&>blockquote]:mb-6"
