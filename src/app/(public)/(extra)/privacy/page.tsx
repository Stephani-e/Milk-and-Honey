        ...
        <div className="flex flex-col bg-slate-50 min-h-screen pb-24">
            ...
            <section className="max-w-4xl mx-auto px-6 -mt-10 relative z-20">
                <div className="bg-white rounded-[2rem] shadow-xl border border-gray-100 p-8 md:p-16">
                    ...
                    <Link href="/"
                          className="inline-flex items-center gap-2 text-sm font-bold text-gray-400 hover:text-brand-primary transition-colors mb-10">
                    ...
                    <div className="prose prose-slate max-w-none text-gray-600 leading-relaxed space-y-10">
                        ...
                        {/* 1. Introduction */}
                        <div>
                            <h2 className="text-2xl font-serif font-bold text-brand-primary mb-4 border-b border-gray-100 pb-2">1.
                                Introduction</h2>
                            <p>
                        ...
                        <div>
                            ...
                            <ul className="list-disc pl-6 space-y-2">
                                <li><strong>Identity Data:</strong> includes first name, last name, or similar
                                    identifiers.
                                </li>
                                <li><strong>Contact Data:</strong> includes email address and telephone numbers.</li>
                                <li><strong>Inquiry Data:</strong> includes prayer requests, testimonies, or any
                                    personal context you choose to share in our contact forms.
                                </li>
                                <li><strong>Technical Data:</strong> includes internet protocol (IP) address, browser
                                    type and version, time zone setting, and operating system (collected automatically
                        ...
                        <div>
                            ...
                            <ul className="list-disc pl-6 space-y-2">
                                ...
                                <li>To route your specific requests to the appropriate church department (e.g.,
                                    Pastoral, Media, or Administrative teams).
                                </li>
                                <li>To manage our relationship with you, including notifying you about changes to our
                                    terms or privacy policy.
                                </li>
                                <li>To administer and protect our website (including troubleshooting, data analysis,
                                    testing, system maintenance, and support).
                                </li>
                            </ul>
                        </div>
                        ...
                        <div className="bg-amber-50/50 p-6 rounded-2xl border border-amber-100">
                            ...
                            <p className="mb-4">
                                As a vibrant church community, we frequently capture photographs, record video/audio,
                                and live stream our services and major events. These media materials are strictly used
                                for our ministry purposes to share the gospel and church life. This includes, but is not
                                limited to, use on our website, official social media channels, promotional materials,
                                and internal archives.
                            </p>
                            <ul className="list-disc pl-6 space-y-3">
                                ...
                                <li>
                                    <strong>Opting Out:</strong> We deeply respect your privacy. If you or a family
                                    member prefer not to be photographed or recorded, please inform one of our ushers
                                    upon arrival, or contact our administrative team via email. We will make every
                                    reasonable effort to accommodate your request and ensure our media team is aware.
                                </li>
                                <li>
                                    <strong>Takedown Requests:</strong> If you see a photo or video of yourself on our
                                    digital platforms that you wish to have removed, please contact us immediately, and
                                    we will take it down promptly.
                                </li>
                            </ul>
                        </div>
                        ...
                        <div>
                            ...
                            <p>
                                ...
                                disclosed. Our databases are secured with modern encryption standards, and access to
                                your personal data is strictly limited to authorized administrative and pastoral staff
                            ...
                            <p className="mt-4">
                                ...
                                operating our website or servicing you, so long as those parties agree to keep this
                        ...
                        {/* 6. Data Retention */}
                        <div>
                            <h2 className="text-2xl font-serif font-bold text-brand-primary mb-4 border-b border-gray-100 pb-2">6.
                                Data Retention</h2>
                            <p>
                                ...
                                reporting requirements. Prayer requests and general inquiries are archived or deleted
                        ...
                        <div className="bg-slate-50 p-8 rounded-2xl border border-gray-100 mt-12">
                            <h2 className="text-xl font-serif font-bold text-brand-primary mb-4">7. Contact Us Regarding
                                Your Privacy</h2>
                            <p className="mb-6">
                                If you have any questions about this privacy policy, or wish to issue a media takedown
