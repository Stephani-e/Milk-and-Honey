        ...
        <body className="min-h-full flex flex-col font-serif relative">
          ...
          <Toaster
            ...
            toastOptions={{
              ...
              `,
                title:
                  "text-[14px] font-semibold text-white/95 tracking-wide mb-0.5",
                ...
                actionButton:
                  "relative z-10 bg-white/95 px-3 py-1.5 text-xs font-bold text-black rounded-lg hover:bg-white transition-all hover:scale-105 active:scale-95 shadow-sm flex-shrink-0",

                // Secondary/Cancel action (Dark translucent button) - Made smaller with hover scale effects
                cancelButton:
                  "relative z-10 bg-white/[0.04] px-3 py-1.5 text-xs font-semibold text-white/90 rounded-lg hover:bg-white/[0.08] transition-all hover:scale-105 active:scale-95 border border-white/[0.05] flex-shrink-0 backdrop-blur-md",
              },
            }}
          />
